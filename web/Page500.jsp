<%-- 
    Document   : Page500
    Created on : 14-ene-2019, 11:54:26
        ...
        <div class="content bg-white text-center pulldown overflow-hidden">
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3">
                    <!-- Error Titles -->
                    <h1 class="font-w600 text-city animated flipInY">500</h1>
                    <h1 class="font-w300 text-city animated flipInY">¡Parece que hubo un error interno!</h1>
                    <h2 class="h3 font-w300 push-50 animated fadeInUp">¡Lamentamos las molestias, intentalo más tarde!</h2>
                    <!-- END Error Titles -->

                    <!-- Search Form -->
                    <div class="col-xs-12">
                        <a href=javascript:history.back(-1); id="icon">
                            <span class="text-danger"><i id="log" class="fa fa-fort-awesome fa-4x"></i></span>
                            <br>
