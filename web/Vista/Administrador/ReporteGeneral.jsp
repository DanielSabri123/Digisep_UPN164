...
<script src="../assets/js/plugins/Validations/ValidacionesReportes.js" type="text/javascript"></script>
...
<input id="txtModulo" name="txtModulo" value="Reportes" style="display: none" disabled="disabled">
