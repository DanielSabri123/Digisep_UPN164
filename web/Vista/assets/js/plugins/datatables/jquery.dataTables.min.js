...
(function(h) {
    ...
    function pb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<div class="form-material form-material-primary input-group remove-margin-t remove-margin-b"><input type="search" class="' + b.sFilterInput + '" style="height:37px;"/><span class="input-group-addon"><i class="si si-magnifier"></i></span></div>',
            j = d.sSearch,
    ...
    function ob(a) {
        for (var b = a.oClasses, c = a.sTableId, d = a.aLengthMenu, e = h.isArray(d[0]), f = e ? d[0] : d, d = e ? d[1] : d, e = h("<select/>", {
                name: c + "_length",
                "aria-controls": c,
                "class": b.sLengthSelect + ' hidden-xs'
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "<a class='block text-center'><div class='block-content block-content-full border-b'><i class='fa fa-exclamation-triangle fa-5x text-primary-dark'></i></div><div class='block-content block-content-full block-content-mini bg-gray-lighter' id='CambioTextupd'>No hay datos disponibles.</div></a>",
            sInfo: "Mostrando _START_ a _END_ de _TOTAL_ coincidencias",
            sInfoEmpty: "Upss... Aún no hay registros.",
            sInfoFiltered: "(filtrados de los _MAX_ registros totales)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
    ...
    h.extend(m.ext.classes, {
        ...
        lengthMenu: "dataTables_filter  pull-left",
        sInfo: "dataTables_info",
        sPaging: "dataTables_paginate paging_",
        sLength: "dataTables_length pull-right",
        sProcessing: "dataTables_processing",
        sSortAsc: "sorting_asc bg-primary-dark",
        sSortDesc: "sorting_desc bg-primary-dark",
        sSortable: "sorting bg-primary-dark",
        sSortableAsc: "sorting_asc_disabled bg-primary-dark",
        sSortableDesc: "sorting_desc_disabled bg-primary-dark",
        sSortableNone: "sorting_disabled bg-primary-dark",
    ...
    h.extend(m.ext.oJUIClasses,
        m.ext.classes, {
            ...
            sSortDesc: H + " sorting_desc bg-primary-dark",
            sSortable: H + " sorting bg-primary-dark",
            sSortableAsc: H + " sorting_asc_disabled bg-primary-dark",
            sSortableDesc: H + " sorting_desc_disabled bg-primary-dark",
            sSortableNone: H + " sorting_disabled bg-primary-dark",
