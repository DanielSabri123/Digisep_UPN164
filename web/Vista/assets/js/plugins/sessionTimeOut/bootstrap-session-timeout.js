...
(function ($) {
    ...
    $.sessionTimeout = function (options) {
        var defaults = {
            ...
            message: 'Tu sesión será cerrada en 5 minutos',
            logoutButton: 'Cerrar Sesión',
            keepAliveButton: 'Permanecer conectado',
            keepAliveUrl: '../Transporte/keep-alive.jsp',
            ajaxType: 'POST',
            ajaxData: '',
            logoutUrl: '../Generales/LogOut.jsp',
            redirUrl: '../Generales/LogOut.jsp',
            warnAfter: 2400000, // 40 minutos
            redirAfter: 2700000, //45 minutos
...
//              </div> \
//             </div>');
            $('body').append('<div class="modal fade" id="session-timeout-dialog" tabindex="-1" role="dialog" aria-hidden="true"> \
                ...
                <div class="modal-content"> \
                    <div class="block block-themed block-transparent remove-margin-b"> \
                        <div class="block-header bg-primary-dark"> \
                            ...
                            <h3 class="block-title" id="modaltitle">' + opt.title + '</h3> \
                        </div> \
                    ...
                    ' + coundownBarHtml + ' \
                        <div class="modal-footer"> \
                                <div class="col-xs-12 push-15t"> \
                                    <button id="session-timeout-dialog-logout" type="button" class="btn btn-default btn-sm">' + opt.logoutButton + '</button> \
